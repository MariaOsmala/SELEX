# 30043694,30043716,30043813,30043923,30044187,30044415 #Ten at a time

# individual k-mers
# 30046865,30047000,30047621

 # -j 30043694,30043716,30043813,30043923,30044187,30044415 |
...
}' > run_claude_canonical_kmers_check_jobs.tsv

#-j 30043694,30043716,30043813,30043923,30044187,30044415 -P --units=K \

sacct -j 30046865,30047000,30047621 -P --units=K \
...
| awk -F'|' 'NR==1 || $1 ~ /\.0$/' > run_claude_canonical_kmers_steps0.csv