...
#outfolder=/scratch/project_2013895/SELEX/streamed_kmers_scaled_by_maxscore/
outfolder=/scratch/project_2013895/SELEX/streamed_kmers_exclude_Methyl-HT-SELEX_scaled_by_maxscore/
mkdir $outfolder

#files=(/scratch/project_2013895/SELEX/streamed_kmers/*.tsv)
files=(/scratch/project_2013895/SELEX/streamed_kmers_exclude_Methyl-HT-SELEX/*.tsv)

echo ${#files[@]} #3461 earlier 3774
