...
check_jobs=read_delim("/projappl/project_2013895/SELEX/generate_kmers_from_seed/experiments/run_claude_canonical_kmers_check_jobs.tsv", delim="\t")
...
steps0=read_delim("/projappl/project_2013895/SELEX/generate_kmers_from_seed/experiments/run_claude_canonical_kmers_steps0.csv", delim="|")
