...
for(index in seq(start_ind, end_ind, 1)){ #0-9
  ...
  all_kmers=paste0(path_local_scratch,"/",data$ID,"_kmers.txt")
  ...
  #test=read_table(output_file, col_names=FALSE)
  ...
  if(file.exists(kmer_count_file) ){
