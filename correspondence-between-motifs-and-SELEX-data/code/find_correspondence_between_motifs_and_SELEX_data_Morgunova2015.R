...
#This is derived from ChIP-seq, not SELEX data
ENA_metadata=read_delim("/projappl/project_2013895/SELEX/download-data/experiments/Morgunova2015_from_ENA/filereport_read_run_PRJEB8671.tsv", delim="\t")
...
metadata_Morgunova2015$CSC_SELEX_filename="/scratch/project_2013895/SELEX/data/Morgunova2015/submitted_ftp/E2F2.fastq.gz"

metadata_Morgunova2015$CSC_SELEX_background_filename=NA
...
tmp=cbind(tmp, ENA_metadata %>% filter(sample_alias=="E2F2"))
